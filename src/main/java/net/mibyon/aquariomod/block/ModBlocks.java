...
public class ModBlocks {
        ...
        public static final DeferredBlock<Block> TICKET_ATM = registerBlock("ticket_atm",
                () -> new TicketAtmBlock(BlockBehaviour.Properties.of()
                        .strength(2f).requiresCorrectToolForDrops().sound(SoundType.METAL).noOcclusion()));
